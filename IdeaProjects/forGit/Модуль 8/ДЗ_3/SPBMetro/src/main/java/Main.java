...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                ...
                LOGGER.info(INPUT_HISTORY_MARKER, "Пользователь ввел станцию прибытия: {}", to);
                ...
                LOGGER.error(EX_MARKER, e.getMessage());                                                        // логер отлова ошибок через try\catch
            }
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            LOGGER.info(INVALID_STATIONS_MARKER, "Пользователь ошибочно ввел станцию: {}", line);
